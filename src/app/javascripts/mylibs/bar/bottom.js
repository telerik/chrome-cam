(function() {
  ...
  define(['Kendo', 'mylibs/utils/utils', 'text!mylibs/bar/views/bottom.html', 'text!mylibs/bar/views/thumbnail.html'], function(kendo, utils, template, thumbnailTemplate) {
