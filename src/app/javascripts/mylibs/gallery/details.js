...
(function() {
  ...
  define(['Kendo', 'mylibs/utils/utils', 'mylibs/file/filewrapper', 'mylibs/tabbing/tabbing', 'text!mylibs/gallery/views/details.html'], function(kendo, utils, filewrapper, tabbing, template) {
