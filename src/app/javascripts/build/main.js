...
define('text!mylibs/gallery/views/gallery.html',[],function () { return '<div class="thumbnails">\n</div>\n\n<script type="text/x-kendo-template" id="gallery-thumbnail">\n    <div class="thumbnail" data-file-name="${fileName}">\n        <img src="${thumbnailUrl}" width="270" height="180">\n        <span class="date">#: dateTaken #</span>\n    </div>\n</script>';});

// Generated by CoffeeScript 1.3.3
(function() {

  define('mylibs/gallery/gallery',['mylibs/utils/utils', 'mylibs/filesystem/filesystem', 'text!mylibs/gallery/views/gallery.html'], function(utils, filesystem, template) {
    var pub;
    return pub = {
      init: function(selector) {
...
(function() {
  ...
  define('app',['mylibs/camera/camera', 'mylibs/bar/bar', 'mylibs/preview/preview', 'mylibs/full/full', 'mylibs/postman/postman', 'mylibs/utils/utils', 'mylibs/filesystem/filesystem', 'mylibs/gallery/gallery', 'text!intro.html'], function(camera, bar, preview, full, postman, utils, filesystem, gallery, intro) {
    var pub;
    return pub = {
      init: function() {
        postman.init();
