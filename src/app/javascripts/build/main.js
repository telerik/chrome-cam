...
define('text!mylibs/gallery/views/gallery.html',[],function () { return '# for (var row = 0; row < rows.length; ++row) { #\n\t<div class="gallery-row">\n\t\t# for (var col = 0; col < rows[row].length; ++col) { #\n\t\t\t<div class="thumbnail" draggable="true">\n\t\t\t\t<img src="#: rows[row][col].image #" width="270" height="180">\n\t\t\t</div>\n\t\t# } #\n\t</div>\n# } #\n';});

// Generated by CoffeeScript 1.3.3
(function() {

  define('mylibs/gallery/gallery',['mylibs/utils/utils', 'text!mylibs/gallery/views/gallery.html'], function(utils, templateSource) {
...
(function() {
  ...
  define('libs/record/record',['libs/record/whammy.min'], function() {});
...
(function() {
  ...
  define('app',['mylibs/camera/camera', 'mylibs/bar/bar', 'mylibs/preview/preview', 'mylibs/full/full', 'mylibs/postman/postman', 'mylibs/utils/utils', 'mylibs/gallery/gallery', 'mylibs/events/events', 'libs/record/record', 'text!intro.html'], function(camera, bar, preview, full, postman, utils, gallery, events, record, intro) {
    var pub;
    return pub = {
      init: function() {
        events.init();
...
define("libs/whammy/whammy",[], function(){});
