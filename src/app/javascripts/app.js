...
(function() {
  ...
  define(['Kendo', 'Glfx', 'mylibs/camera/camera', 'mylibs/bar/bottom', 'mylibs/bar/top', 'mylibs/popover/popover', 'mylibs/full/full', 'mylibs/postman/postman', 'mylibs/utils/utils', 'mylibs/gallery/gallery', 'mylibs/gallery/details', 'mylibs/events/events', 'mylibs/file/filewrapper', 'mylibs/settings/settings', 'mylibs/about/about', 'mylibs/confirm/confirm', 'mylibs/assets/assets', 'mylibs/effects/effects', 'libs/record/record'], function(kendo, glfx, camera, bottom, top, popover, full, postman, utils, gallery, details, events, filewrapper, settings, about, confirm, assets, effects, record) {
    var pub;
    return pub = {
      init: function() {
        var APP;
