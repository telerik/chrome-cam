define [
	...
	# 'order!libs/kendo/kendo.popup'
	# 'order!libs/kendo/kendo.mobile.popover'
	...
	# 'order!libs/kendo/kendo.touch.min'
	# 'order!libs/kendo/kendo.userevents.min'
	'order!libs/kendo/kendo.all'
