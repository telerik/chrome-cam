...
(function() {
  ...
  define(['mylibs/postman/postman', 'mylibs/utils/utils', 'mylibs/file/file', 'mylibs/notify/notify', 'mylibs/assets/assets', 'mylibs/localization/localization', 'libs/face/track'], function(postman, utils, file, notify, assets, localization, face) {
    'use strict';
