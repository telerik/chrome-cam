...
(function() {
  ...
  define(['mylibs/postman/postman', 'mylibs/utils/utils', 'mylibs/file/file', 'mylibs/intents/intents', 'mylibs/notify/notify', 'mylibs/assets/assets', 'mylibs/localization/localization', 'libs/face/track'], function(postman, utils, file, intents, notify, assets, localization, face) {
    'use strict';
