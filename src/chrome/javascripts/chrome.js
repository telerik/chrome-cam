...
(function() {
  ...
  define(['mylibs/postman/postman', 'mylibs/utils/utils', 'mylibs/file/file', 'mylibs/localization/localization', 'mylibs/camera/camera', 'mylibs/link/opener'], function(postman, utils, file, localization, camera, opener) {
    'use strict';
